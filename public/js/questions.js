export const questions = {
  ...
  RapidFire: [
    ...
    "Name YOUR favorite childhood cartoon",
    "Name YOUR favorite video game",
    "Name YOUR favorite app on your phone",
    "Name YOUR favorite ice cream flavor",
    "Name YOUR favorite pizza topping",
    "Name YOUR favorite place to relax",
    "Name YOUR favorite fast food chain",
    ...
    "Name YOUR favorite emoji",
    "Name YOUR favorite clothing brand",
    "Name YOUR favorite teacher",
    "Name YOUR favorite phone feature",
    "Name YOUR favorite place on campus",
    "Name YOUR favorite quote",
    "Name YOUR favorite snack",
    "Name YOUR favorite social media platform",
    "Name YOUR favorite thing about weekends",
    "Name YOUR favorite place you’ve traveled",
    "Name YOUR favorite memory from last year",
    "Name YOUR favorite invention",
    "Name YOUR favorite subject to talk about",
    "Name YOUR favorite time of day",
    "Name YOUR favorite celebrity couple",
    "Name YOUR favorite childhood book",
    "Name YOUR favorite breakfast food",
    "Name YOUR favorite thing about yourself",
    "Name YOUR favorite silly joke",
  ],
};
